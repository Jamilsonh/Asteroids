...
public class GameOverManager : MonoBehaviour
{
    ...
    public TMP_Text scoreTextUI; // refer�ncia ao texto de score que aparece durante o jogo
    public TMP_Text scoreNumberUI; // refer�ncia ao texto de score que aparece durante o jogo
